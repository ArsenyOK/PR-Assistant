      ...
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col px-6 py-10">
        <header className="flex items-center justify-between border-b border-slate-800 pb-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-lg font-semibold">MergeAssistant</p>
        ...
        <section className="grid flex-1 items-center gap-12 py-16 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-slate-400">
              MergeAssistant helps teams run AI-powered PR reviews, highlight
              risk level, suggest improvements, and keep review flow clean with
